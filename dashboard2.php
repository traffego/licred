...
?>
    ...
    <div class="container py-5">
        ...
        <h2 class="mb-4">🚀 Painel Financeiro</h2>
          ...
          <div class="bg-body-tertiary bg-opacity-90 px-3 py-3 mx-n4 mx-md-n5 text-center my-4">
    <div class="text-center text-body-emphasis">
  Essa faixa ignora tudo e vai de ponta a ponta!
</div>
  </div>



        <div class="row g-3 my-slider">
